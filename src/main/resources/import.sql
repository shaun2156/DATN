...
INSERT INTO datn.role (role_id, role_name, description)
VALUES (1, 'admin', 'System Administrator');
INSERT INTO datn.role (role_id, role_name, description)
VALUES (2, 'storage_manager', 'Storage Manager Employee');
INSERT INTO datn.role (role_id, role_name, description)
VALUES (3, 'store_owner', 'Owner of the System');
INSERT INTO datn.role (role_id, role_name, description)
VALUES (4, 'store_manager', 'Store Content Manager Employee');

INSERT INTO datn.person (person_id, email, full_name, password, short_name, username)
VALUES (1, 'admin@example.com', 'Shop Admin', '1', 'SA', 'admin');
INSERT INTO datn.employee (join_date, person_id, rank)
VALUES (NOW(), 1, 1);
INSERT INTO datn.employee_role_access (role_access_id, employee_id, role_id)
VALUES (1, 1, 1);
INSERT INTO datn.employee_role_access (role_access_id, employee_id, role_id)
VALUES (2, 1, 2);
INSERT INTO datn.employee_role_access (role_access_id, employee_id, role_id)
